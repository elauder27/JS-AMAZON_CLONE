...
class Product {
  ...
  //converting an object into a class instance
...
export function loadProductsFetch() {
  const promise = fetch("https://supersimplebackend.dev/products") //uses a promise and takes a url
    .then((response) => {
      return response.json(); //asynchronous and returns a promise
    })
    .then((productsData) => {
